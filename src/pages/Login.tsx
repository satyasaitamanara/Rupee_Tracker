          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-4 py-3 bg-white bg-opacity-10 border border-gray-300 border-opacity-20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
            ...
            <button
              ...
              className={`group relative w-full flex justify-center py-3 px-4 rounded-xl text-sm font-semibold text-white transition duration-200 ${
                isLoading
                  ...
                  : 'hover:scale-[1.02]'
              } bg-gradient-to-r from-blue-500 to-purple-600 shadow-lg hover:shadow-xl transform`}
            >
              {isLoading ? (
